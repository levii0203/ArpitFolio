...
import Additionalskills from './components/Additional';
import More from './components/More';
import Webthree from './components/Web3';
export default function Home() {
  return (
    <main className="flex flex-col h-screen bg-black min-h-screen">
      <div>
        <Hero />
      </div>
      <div className="hidden sm:flex md:w-full md:flex-col flex-col bg-black w-full h-fit">
                        ...
                        'Check my Github...'
                         ...
                         speed={50}
                          style={{ display: 'inline-block' }}
                           repeat={Infinity}
                          className="text-xl px-0 font-bold font-mono pt-14 text-white"
             />
    ...
    <div className='flex lg:flex-row lg:pt-24 lg:px-20 md:pt-10 md:flex-col  h-full w-full flex-direction:column; bg-black lg:space-x-0'>
      ...
      <div className=' lg:w-[800px] lg:h-[80px] md:h-full md:w-fit md:pt-12 lg:pt-12 lg:px-12 md:px-24 w-[800px] bg-black '>
        ...
        '> <p className='lg:text-4xl md:text-3xl text-gray-400'>
          ...
          <p className="lg:text-lg md:text-lg text-white font-bold">What</p>
                   ...
                   sequence={[
                        ...
                        500,
                         ...
                         speed={50}
                          style={{ display: 'inline-block' }}
                           repeat={Infinity}
                          className="text-xl px-0 font-bold font-mono text-transparent bg-clip-text  bg-gradient-to-tr from-blue-500 to-cyan-500"
             />
